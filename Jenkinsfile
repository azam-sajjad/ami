pipeline {
    agent any
    parameters { 
        choice(name: 'AWS_REGION', choices:['us-east-1', 'us-east-2', 'us-west-2', 'ap-south-1', 'ap-northeast-3', 'ap-northeast-2', 'ap-southeast-1', 'ap-southeast-2', 'ca-central-1', 'eu-central-1', 'eu-west-1', 'eu-west-2', 'eu-west-3', 'eu-north-1', 'sa-east-1'], description:'Select Region for AMI')
        ...
        choice(name: 'FIREWALL', choices:['iptables', 'firewalld', 'ufw', 'nftables'], description:'Firewall to Setup for the AMI')
        string defaultValue: '44.198.48.70', description: 'Allow SSH login only from a Specific IP Address', name: 'SSH_SOURCE_IP'
        booleanParam defaultValue: false, description: 'Accept New SSH Connections from all Sources on Port 22 besides the Source IP listed above? (Check for Yes)', name: 'ACCEPT_NEW_SSH'
        ...
        booleanParam defaultValue: true, description: 'Block ALL SSH Access, Level2 sshd_config, Remove Keys, /etc/hosts.deny', name: 'LOCKDOWN'
